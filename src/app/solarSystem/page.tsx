    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            This web application provides an interactive 3D representation of
            the Solar System. Built with modern web technologies including
            ReactJS for the front-end, Three.js for 3D rendering, and
            React-Three-Fiber for integrating Three.js with React, the
            application offers an engaging and educational experience for users
          ...
          <button className="px-8 py-2 mt-4 mr-8">
            <a
              target="_blank"
              href="https://cs105-solar-system.vercel.app/"
          ...
          <button className="px-8 py-2 mt-4">
            <a
              target="_blank"
              href="https://github.com/khanhvinhnguyen/CS105-solar-system"
              rel="noopener noreferrer"
            >
              Code
            </a>
